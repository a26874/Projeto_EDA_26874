...
int menu()
{
    ...
    printf("7- Adicionar Gestores.\n");
    printf("8- Listar os meios disponiveis.\n");
    printf("9- Listar os meios disponiveis.\n");
...
//Gestor* lerFicheiro_gestor(Gestor* inicio, FILE* dados_gestor)
//{
//    char linha[MAX_LINE_LEN];
//    while (fgets(linha, MAX_LINE_LEN, dados_gestor))
//    {
//        Gestor* novo_nodo = malloc(sizeof(struct registo_gestor));
//        sscanf(linha, "%d;%[^;];%f;%f\n", &novo_nodo->codigo, novo_nodo->tipo, &novo_nodo->bateria, &novo_nodo->autonomia);
//        novo_nodo->seguinte_gestor = inicio;
//        inicio = novo_nodo;
//    }
//    fclose(dados_gestor);
//    return inicio;
...
//    {
//        printf("Codigo:%d; Nome:%s; Meio:%s; Saldo:%d\n", inicio_clientes->codigo, inicio_clientes->nome, inicio_clientes->tipoMobilidade, inicio_clientes->saldo);
//        inicio_clientes = inicio_clientes->seguinte_cliente;
//    }
//}
